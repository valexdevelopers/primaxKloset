                                ...
                                <div class="recent-orders white-bg with-box-shadow">
                                    <div class="rows recent-orders-header">
                                        <div class="count-invoice">
                                            ...
                                            <div class="">
                                                <a href="{{ route('admin.product.create') }}" class="create-invoice-btn darkblue-bg no-text-deco color-cream"> <i class="bi bi-plus"></i> <span>Create Product</span></a>
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <div class="Categories-wrap">
                                                        ...
                                                        <p class="Category-names mb-0" title="{{ $prodCat->collection_name }}">{{ $prodCat->collection_name }}</p>
                                                ...
                                                <td class="grey-text" style="color: #6f6b7d;"><span>
                                                    @if($product->product_price === 0)
                                                        ₦{{$product->variations->min('product_price')}} - ₦{{$product->variations->max('product_price')}}
                                                    @else
                                                ...
                                                <td class="grey-text"><span>{{ Str::upper($product->variations->count()) }}</span> </td>
                                                <td class="grey-text"> <span>{{ $product->quantity }}</span></td>
                                                <td>
                                                    <div class="actions-td">
                                                        ...
                                                        <div class="extra-actions with-box-shadow white-bg" id="extra-actions">
                                                            ...
                                                            <form class="" method="post" action="{{ route('admin.product.delete', $product_id = $product->id) }}">
                                                                @method('delete')
                                                                @csrf
