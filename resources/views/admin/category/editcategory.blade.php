...
<html>
    <head>
        <title>Edit {{ $category->collection_name }} | Admin</title>
                    ...
                    <div class="main-page-wrapper">
                        ...
                        <section class="scroll-y">
                            <div>
                                <div class="header-details">
                                    <div>
                                        <div class="order-id-wrap">
                                            <h6 class="">{{ $category->collection_name }}</h6>
                                ...
                                <div class="padding-5">
                                    <form method="post" action="{{ route('admin.category.update', $category = $category) }}" enctype="multipart/form-data">
                                        @method('patch')
                                        @csrf
                                        @if ($errors->any())
                                            ...
                                            <div class=" grid-col-70 ">
                                                ...
                                                <div class="product-image-dropzone mt-20 mt-20-sm mt-20 mt-20-sm with-box-shadow white-bg rounded-edges padding-20">
                                                    ...
                                                    <div class="file-upload-wrapper">
                                                        ...
                                                        <input name="collection_image" accept="image" type="file" id="banner-images-input" class="product-image-upload file-upload @error('collection_image') is-invalid @enderror" data-height="500" multiple/>
                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="collection_id" value="{{ $category->id }}">
                                                                <input value="{{ $category->collection_name }}" name="collection_name" required type="text" class="form-control appearance-text-field @error('collection_name') is-invalid @enderror " placeholder="Category Name">
