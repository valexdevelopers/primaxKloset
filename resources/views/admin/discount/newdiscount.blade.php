                                                    ...
                                                    <div class="row form-row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                @include('includes.salesProductSelection')
                                                                <label class="form-label flexed-label" ><span class="flexed-label-span">Category</span> <a href="{{ route('admin.category.create') }}" class="flexed-label-anchor">New Category</a></label>
