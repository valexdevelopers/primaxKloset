                                ...
                                <div class="recent-orders white-bg with-box-shadow">
                                    <div class="rows recent-orders-header">
                                        <div class="count-invoice">
                                            ...
                                            <div class="">
                                                <a href="../register" class="create-invoice-btn darkblue-bg no-text-deco color-cream"> <i class="bi bi-plus"></i> <span>New Admin</span></a>
                                        ...
                                        <div class="inner-search">
                                            <form>
                                                ...
                                                <div class="row form-row inner-search-form-row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <select criteria="admin" id="filter" class="form-select" aria-label="Default select example">
                                        ...
                                        <tbody>
                                            @foreach($admins as $admin)
                                                <tr >
                                                    ...
                                                    <td class="grey-text" style="color: #6f6b7d;"><span>{{ $admin->products->count() }}</span> </td>
